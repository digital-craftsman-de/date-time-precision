...
final class IsDateNotBeforeInTimeZoneTest extends TestCase
{
    /**
     * @test
     *
     ...
     *
     * @covers ::isDateNotBeforeInTimeZone
     */
    public function is_date_not_before_in_time_zone_works(
        bool $expectedResult,
        DateTime $dateTime,
        DateTime $comparator,
        ...
        // -- Act & Assert
        self::assertSame($expectedResult, $dateTime->isDateNotBeforeInTimeZone($comparator, $timeZone));
    }
