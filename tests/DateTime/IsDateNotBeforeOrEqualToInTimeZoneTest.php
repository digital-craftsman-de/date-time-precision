...
final class IsDateNotBeforeOrEqualToInTimeZoneTest extends TestCase
{
    /**
     * @test
     *
     ...
     *
     * @covers ::isDateNotBeforeOrEqualToInTimeZone
     */
    public function is_date_not_before_or_equal_to_in_time_zone_works(
        bool $expectedResult,
        DateTime $dateTime,
        DateTime $comparator,
        ...
        // -- Act & Assert
        self::assertSame($expectedResult, $dateTime->isDateNotBeforeOrEqualToInTimeZone($comparator, $timeZone));
    }
