...
final class IsDateNotEqualToInTimeZoneTest extends TestCase
{
     ...
     *
     * @covers ::isDateNotEqualToInTimeZone
     */
    public function is_date_not_equal_to_in_time_zone_works(
        bool $expectedResult,
        Moment $dateTime,
        Moment $comparator,
        ...
        // -- Act & Assert
        self::assertSame($expectedResult, $dateTime->isDateNotEqualToInTimeZone($comparator, $timeZone));
    }
